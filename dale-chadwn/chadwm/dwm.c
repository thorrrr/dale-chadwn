...
void arrangemon(Monitor *m) {
  ...
  printf("Setting ltsymbol to: %s\n", m->lt[m->sellt]->symbol);
  printf("manage(): Before arrangemon, ltsymbol: %s\n", m->ltsymbol);
  printf("Updated ltsymbol after arrangemon: %s\n", m->ltsymbol);
  printf("manage(): Current layout symbol before arrangemon: %s\n", m->ltsymbol);
